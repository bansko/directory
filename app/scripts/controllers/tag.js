...
angular.module('directoryApp')
  .controller('TagCtrl', function ($scope, $routeParams, BusinessApi, util) {
    $scope.tagId = $routeParams.tagId;
    BusinessApi.query({}, function (businesses) {
      $scope.businesses = util.shuffle(businesses.filter(function (x) { return x.live && x.tags.includes($routeParams.tagId); }));
